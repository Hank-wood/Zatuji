...
public class UserHelper {
    public static void saveCurrentUser(User user){
        ...
        PrefUtils.putString(Constant.USER_AVATAR, user.avatar);
    }
    ...
    public static void saveAvatar(String url){
        PrefUtils.putString(Constant.USER_AVATAR, url);
    }
    public static String getAvatart(){
        return PrefUtils.getString(Constant.USER_AVATAR,"");
    }
